...
package org.mangui.hls.playlist {
	...
	public class Manifest {
		...
		/** Tag that describes whether caching is allowed */
		private static const ALLOWCACHE : String = '#EXT-X-ALLOW-CACHE';
		/** Tag that describes playlist type */
		private static const PLAYLISTTYPE : String = '#EXT-X-PLAYLIST-TYPE';
		/** Tag that indicates I-frames only */
		private static const IFRAMESONLY : String = '#EXT-X-I-FRAMES-ONLY';
		/** Tag that describes I-frame stream information */
		private static const IFRAMESTREAMINF : String = '#EXT-X-I-FRAME-STREAM-INF';
		...
		private static function _extractURL(path : String, base : String) : String {
			...
			if (/^https?:\/\//.test(path)) {
				...
				if (path.charAt(0) == '/') {
					...
					var _prefix : String = base.substr(0, base.indexOf("//") + 2);
					var _suffix : String = base.substr(base.indexOf("//") + 2);
					if(path.charAt(1) == '/') {
