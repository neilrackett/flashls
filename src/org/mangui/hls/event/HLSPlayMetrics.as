...
package org.mangui.hls.event {
    ...
    public class HLSPlayMetrics {
        ...
        public function HLSPlayMetrics(level : int, seqnum : int, cc : int, duration : Number, audio_only : Boolean, program_date : Number, video_width : int, video_height : int, auto_level : Boolean, pts : Number, tag_list : Array, id3tag_list : Array) {
            this.level = level;
            this.seqnum = seqnum;
